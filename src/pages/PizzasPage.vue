...
<template>
  <div class="max-w-6xl mx-auto px-3">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-y-5 gap-x-3">
      <div class="border border-primary/50 rounded-md " v-for="(pizza, index) in pizzas" :key="index">
        ...
        <div class="text-center text-lg mt-3">
          ...
          <span class="px-2 py-1 font-bold text-primary" v-if="pizza.discountPercent">
