...
<template>
  <nav class="fixed w-full z-20 top-0 start-0">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
      <a href="#menu" class="bg-primary text-white px-3 py-1 rounded text-sm uppercase cursor-pointer transition-all duration-300 hover:bg-primary/70">
        Ordina
      </a>
      <div class="max-w-[80px] sm:max-w-[120px] block md:hidden">
      ...
      <div class="flex items-center md:order-2 space-x-3 md:space-x-0 ">
          <button type="button" class="bg-primary text-white px-3 py-1 rounded text-sm uppercase cursor-pointer transition-all duration-300 hover:bg-primary/70">Login</button>
          <button @click="showMenu = !showMenu" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
      ...
      <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" :class="{ 'hidden': !showMenu, 'block': showMenu }">
        <ul class="flex flex-col gap-3 md:gap-0 p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 rtl:space-x-reverse md:flex-row md:items-center md:mt-0 md:border-0 md:bg-white dark:bg-gray-800/80 md:dark:bg-transparent dark:border-gray-700">
          ...
          <li>
            <div class="max-w-[120px] hidden md:block">
          ...
          <li>
            <a href="#" class="group flex items-center justify-center hover:text-primary text-sm gap-1 py-2 px-3 text-white rounded md:bg-transparent uppercase">
                <div class="relative">
                  ...
                  <div class="group-hover:text-white absolute -top-[10px] -left-[10px] text-xs flex items-center justify-center w-5 h-5 bg-primary rounded-full ">
                    0
                  </div>
                </div>
              cart
